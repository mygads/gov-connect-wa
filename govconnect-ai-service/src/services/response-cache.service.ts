...
const NON_CACHEABLE_PATTERNS = [
  ...
  /\b(cek|status)\s+(laporan|reservasi|tiket)\b/i,
  /\bLAP-\d+/i,
  /\bRSV-\d+/i,
  ...
  const commonResponses: Array<{ query: string; response: string; intent: string; guidance?: string }> = [
    {
      ...
      guidance: 'Mau saya buatkan reservasi biar tidak perlu antri lama? 😊',
    },
    {
    ...
    },
    {
      ...
      intent: 'KNOWLEDGE_QUERY',
      guidance: 'Mau saya bantu buatkan reservasi sekarang?',
    },
    {
